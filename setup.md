...
1. I went on the Draginuo website and found the user manual and began to program and assemble based off of the steps and images. 
2. The kit required at the start Arduino and a drivers download so the computer can detect when an item from the kit is connected wirelessly or through the USB port. 
3. I have a mac and finding how to download the drivers software was difficult. 
4. I found this website with a video and preexisting commands for my terminal so i can download and install
It didn't do anything, I tried it twice, and my computer still wasn't picking it up
5. I asked my team for some help and I had to wait a couple days until they figured it out. 
6. Armaan found this website that didn't need the terminal, and I downloaded it. 
